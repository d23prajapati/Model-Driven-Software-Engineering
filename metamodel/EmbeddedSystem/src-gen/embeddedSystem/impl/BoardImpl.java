 ...
 * </p>
 * <ul>
 *   <li>{@link embeddedSystem.impl.BoardImpl#getName <em>Name</em>}</li>
 *   <li>{@link embeddedSystem.impl.BoardImpl#getPinGroups <em>Pin Groups</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoardImpl extends MinimalEObjectImpl.Container implements Board {
	...
	protected EClass eStaticClass() {
		return EmbeddedSystemPackage.Literals.BOARD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmbeddedSystemPackage.BOARD__NAME, oldName, name));
	}
	...
	public EList<PinGroup> getPinGroups() {
		if (pinGroups == null) {
			pinGroups = new EObjectContainmentEList<PinGroup>(PinGroup.class, this,
					EmbeddedSystemPackage.BOARD__PIN_GROUPS);
		}
		return pinGroups;
	}
