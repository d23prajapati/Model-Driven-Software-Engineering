 ...
 * </p>
 * <ul>
 *   <li>{@link embeddedSystem.impl.OpaqueBehaviorImpl#getCommandLine <em>Command Line</em>}</li>
 *   <li>{@link embeddedSystem.impl.OpaqueBehaviorImpl#isIsMain <em>Is Main</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OpaqueBehaviorImpl extends BehaviorImpl implements OpaqueBehavior {
	...
	protected EClass eStaticClass() {
		return EmbeddedSystemPackage.Literals.OPAQUE_BEHAVIOR;
	}
	...
	public void setCommandLine(String newCommandLine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmbeddedSystemPackage.OPAQUE_BEHAVIOR__COMMAND_LINE,
	...
	public void setIsMain(boolean newIsMain) {
		...
		isMain = newIsMain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmbeddedSystemPackage.OPAQUE_BEHAVIOR__IS_MAIN,
					oldIsMain, isMain));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EmbeddedSystemPackage.OPAQUE_BEHAVIOR__COMMAND_LINE:
			return getCommandLine();
		case EmbeddedSystemPackage.OPAQUE_BEHAVIOR__IS_MAIN:
			return isIsMain();
		}
